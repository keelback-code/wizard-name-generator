const wizardFirstNames = ["Scout", "Starmaker", "Ziggy", "Moonage", "Velvet", "Data", "Hoggle", "Rudi", "Izzy", , "Dawizard", "Genesis", "Groulf", "Ged", "Sparrowhawk", "Zorgon", "Neb", "Jesha", "Kin", "Lorsa", "Kay", "Emice", "Donn", "Klegg", "Bean", "Zues", "Alta", "Celestial", "Jatz", "Tam", "Merlyn", "Taliesin", "Spacedrop", "Oblivia", "Laser", "Action", "Sparky", "Ulgrub", "Ulm", "Germ", "Hobb", "Sneer", "Aborghast", "Mew", "Storm", "Geld", "Blue", "Winnifrederico", "Soup", "Jillius", "Lox", "Pollux", "Abie-See Diefgie", "Tomby", "Aeiou", "Xippy", "Zoot", "Poot", "Pteey", "Stray", "Greg", "Therai", "Falkon", "Cod", "Rina", "Ilia", "Claudia", "Oskar", "Dawizard", "Big V", "Rahadin", "Kompooter", "Book", "Vul", "Hoggard", "Furio", "Zemrak", "Nickel", "Apprentice", "Rona", "Neko", "Rouge", "Billiard", "Aster", "Student", "Rookie", "Novice", "Fledgling", "Stranger", "Outsider", "M.", "G.", "K.", "F.", "E.", "Pupil", "Buttoncup", "Elderbell", "Jammie", "Dodgers", "Monte", "Danish", "Wizardy", "Sogg", "Miasma", "Rasmodius"];
...
const nonsenseSyllableOne = ["So", "O", "Oo", "Ooo", "Oooo", "A", "Re", "X", "Pw", "L", "Bea", "Hr", "Oo", "O", "E", "I", "U", "Y", "S", "K", "Kly", "Xa", "Fr", "Br", "Ooo", "Io", "Ao", "Yo", "Dy", "Sy", "Gy", "Bh", "Ghr", "F", "Fo", "If", "Chy", "K", "A", "Fuc", "Fuk", "Lo", "Ba", "Xe", "Z", "Za", "Zy", "Xy", "Vi", "Vo", "C", "R", "V", "Pl", "Bl", "Wa", "W", "T", "S", "Sooo", "R", "Gha", "P", "O", "Q", "Qe", "N", "M", "L", "K", "Ql", "Fl", "J", "I", "Xa", "H", "G", "F", "Mike", "E", "D", "C", "B", "A", "A", "E", "I", "O", "U", "A", "E", "I", "O", "U", "A", "E", "I", "O", "U", "A", "E", "I", "O", "U", "Ae", "Ee", "I", "Oo", "U", "A", "E", "I", "O", "U"];
const nonsenseSyllableTwo = ["oo", "er", "ooo", "oooo", "on", "om", "ol", "op", "opo", "olo", "pe", "er", "ar", "yr", "oup", "py", "ay", "pp", "aa", "e", "ee", "eep", "ho", "ewe", "ewee", "yet", "ye", "uh", "oh", "ol", "oj", "ouo", "oma", "rin", "oku", "ai", "ah", "er", "es", "se", "ect", "eb", "he", "uh", "ik", "uk", "ok", "ek", "ak", "ek", "yk", "yy", "ommy", "on", "onny", "in", "oy", "thy", "eft", "ash", "adv", "oby", "ajo", "fa", "aja", "ak", "al", "ala", "era", "ka", "eye", "alp", "elp", "yg", "yl", "wl", "asp", "sp", "usp", "eek", "oky", "ool", "oll", "ees", "oss", "aal", "eel",];
const nonsenseSyllableThree = ["ep", "o", "oo", "ooo", "oooo", "oopy", "eepy", "h", "ghy", "p", "ap", "thy", "ing", "i", "t", "a", "e", "ter", "oup", "a", "r", "po", "gol", "gor", "vox", "fox", "f", "xo", "ox", "x", "ra", "plax", "bra", "z", "s", "ose", "yet", "eth", "yeet", "th", "y", "lly", "gy", "un", "n", "th", "r", "k", "rty", "m", "py", "pappy", "prip", "ler", "xerp", "rx", "x", "bax", "ap", "ab", "eb", "s", "ep", "ib", "ip"];
let printHistory = [];
let rotationStart = 0;
...
function nonsenseRoll() {
    ...
    const nonsenseNum3 = Math.floor(Math.random() * nonsenseSyllableThree.length);
    ...
    document.getElementById("nonsense-result-syllable-three").textContent = `${(nonsenseSyllableThree[nonsenseNum3])}`;
}
...
function createNonsenseNameHistory() {

    const firstNonsenseSyllable = document.getElementsByClassName("name-display")[0].textContent;
    const secondNonsenseSyllable = document.getElementsByClassName("name-display")[1].textContent;
    const thirdNonsenseSyllable = document.getElementsByClassName("name-display")[2].textContent;
    const names = " " + firstNonsenseSyllable + secondNonsenseSyllable + thirdNonsenseSyllable;
    const li = document.createElement("li");
    document.getElementsByClassName("name-history-storage")[0].appendChild(li);
    printHistory.push(names);
    li.textContent += printHistory[printHistory.length - 1];
